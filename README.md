...
- Location-Based AR Bus Stop Finder mode backed by the live camera preview, rotation-vector sensor fusion, true-north magnetic declination correction, a GPS accuracy lock with a 5-second **Bypass Calibration** fallback, smoothed updates, a force-rendered neon navigation wall, mini-map path overlay, Future HUD, ghost-bus silhouettes, virtual shelter hints, and high-contrast bus billboards with destination, ETA, and occupancy.
